...
(def sets-that-work
  #{:HOU :AKH :AER :KLD :EMN :SOI :OGW :BFZ :ORI :DTK :FRF :KTK :M15 :JOU :BNG
    :THS :M14 :DGM :GTC :RTR :M13 :AVR :DKA :ISD :M12 :NPH :MBS :SOM :M11 :ROE
    :WWK :ZEN :M10 :ARB :CON :ALA :EVE :SHM :MOR :LRW (keyword "10E") :CSP :DIS
    :GPT :RAV (keyword "9ED") :SOK :BOK :CHK :UNH (keyword "5DN") :DST :MRD
